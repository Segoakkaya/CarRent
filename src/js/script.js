            ...
            $(".btnFilter").on("click",function(){
                ...
                $("#sedancount").text("("+sedancount+")");
                        ...
                        $(".miniBtn2").on("click",function(){
                            ...
                            $(".informations-box1-fluid").css({"background-image":"url('assets/img/minimg1.png')","background-repeat":"no-repeat"});
                        });
                        $(".miniBtn3").on("click",function(){
                            $(".informations-box1-fluid img").hide();
                            $(".informations-box1-fluid").css({"background-image":"url('assets/img/minigm2.png')","background-repeat":"no-repeat"});
                        });
